...
public class MainActivity extends AppCompatActivity implements OnItemClickListener {
    ...
    public static final Artista artista = new Artista();
...
/*        MainActivity.artista.setId(artista.getId());
        MainActivity.artista.setNombre(artista.getNombre());
        MainActivity.artista.setApellidos(artista.getApellidos());
        MainActivity.artista.setFechaNacimiento(artista.getFechaNacimiento());
        MainActivity.artista.setEstatura(artista.getEstatura());
        MainActivity.artista.setLugarNacimiento(artista.getLugarNacimiento());
        MainActivity.artista.setOrden(artista.getOrden());
        MainActivity.artista.setNotas(artista.getNotas());
        MainActivity.artista.setFotoUrl(artista.getFotoUrl());
